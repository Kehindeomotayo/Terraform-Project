...
arn:aws:cloudformation:us-east-1:461164599838:stack/StackSet-Bg-PlatformMonitoringServer-StackSet-5b33c90a-db33-4d65-84a1-9e54d95ad891/906e94a0-3819-11f1-8e28-0ea5af7cf5ad
CANCELLED
fcc6f6ed-40b3-626d-10a7-c05c2834c939
Cancelled since failure tolerance has exceeded
NOT_CHECKED
-
959563671843
...
INOPERABLE
fcc6f6ed-40b3-626d-10a7-c05c2834c939
ResourceLogicalId:BgAdminUser, ResourceType:AWS::IAM::User, ResourceStatusReason:Resource handler returned message: "Cannot delete entity, must delete policies first. (Service: Iam, Status Code: 409, Request ID: 10565f16-0250-4ff8-8ad2-4b6abe3a1a50) (SDK Attempt Count: 1)" (RequestToken: 1f7c4161-c4c2-a1bd-d478-55e60b8cd8e0, HandlerErrorCode: GeneralServiceException).
NOT_CHECKED
-
